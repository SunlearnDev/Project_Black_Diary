<div class="container mx-auto py-10 h-screen md:w-3/5 w-10/12 px-6 bg-neutral-900">
    <?php
    ...
    if ($userResult) {
        while ($row = mysqli_fetch_assoc($userResult)) { ?>
            ...
            <div diary-id="<?php echo $row['id']; ?>" class="parent-content w-full h-auto rounded border-solid border-2 border-gray-300 bg-black p-4 mb-4">
                <div class="flex justify-between mb-2">
                    ...
                    ?>
                        <div class="relative">
                            <button class="open-setting h-10 w-10   duration-500 flex items-center shadow  justify-center cursor-pointer text-white">
                                ...
                                <ul class=" p-2 backdrop-blur bg-gray-700  rounded-md">
                                    ...
                                    <li>
                                        <?php if ($rows['id'] === $row['userID']) { ?>
                                            <button class="text-white flex justify-start items-center p-2  w-32 hover:bg-gray-800 rounded-md js-setting " data-id="<?php echo $row['id']; ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" mr-2 w-4 -h-4">
                                    ...
                                    <li>
                                        <form action="curd.php" method="POST" enctype="multipart/form-data" class="mb-0">
                                            ...
                                            if ($rows['id'] == $row['userID']) { ?>
                                                <div class="">
                                                    <input type="hidden" class="hidden" name="id_delet" value="<?php echo $row['id']; ?>">
                                                    <button class="text-white flex justify-start items-center p-2  w-32 hover:bg-gray-800 rounded-md " name="deleter">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" mr-2 w-4 -h-4">
                ...
                <div class="w-full p-2 mb-2 border border-gray-200 rounded-lg bg-black dark:bg-gray-700 dark:border-gray-600">
                                        ...
                                        <li comment-id="<?php echo $cmt['id']; ?>" user-id="<?php echo $cmt['userID']; ?>">
                                            <div class="flex gap-2">
                                                <div class="w-8 h-8 shrink-0">
                                                    <img class="bg-white w-full h-full p-1 rounded-full ring-2 ring-gray-400 dark:ring-gray-500 dark:bg-transparent" src="<?php echo $cmt['avatar']; ?>" alt="">
                                                </div>
                                                <div>
                                                    <div class="inline-block px-2 py-1 rounded-lg border border-gray-300 bg-white dark:bg-gray-800 dark:border-none break-words">
                                                    ...
                                                    <div class="flex">
                                                        <div class="time text-xs text-gray-500 dark:text-white" data-timeago="<?php echo $cmt['createdAt']; ?>"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                ...
                <form>
                    <div class="flex items-center px-3 py-2 rounded-lg bg-black dark:bg-gray-700">
