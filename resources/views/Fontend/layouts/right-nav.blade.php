<aside class="w-44 md:w-56 lg:w-64 h-screen sm:block hidden">
    <div class="flex flex-col items-center">
        <div class="w-full bg-white shadow flex flex-col my-4  rounded-md">
           ...
           <div class=" border-b py-2 px-6  w-full">
            <p class=" text-sm font-medium">What was your win this week?</p>
        ...
        <div class="w-full bg-white shadow flex flex-col my-4  rounded-md">
            <p class="text-xl font-bold pb-5 border-b px-6 py-2">#challenge</p>
           <div class=" border-b py-2 px-6  w-full">
            <p class=" text-sm font-medium">What was your win this week?</p>
            <p class=" text-xs font-normal text-gray-400 ">3 cmt</p>
           </div>
