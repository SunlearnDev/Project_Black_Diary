{{-- header  --}}
<nav class="fixed dark:backdrop-blur-2xl  dark:bg-opacity-30 top-0 z-50 w-full h-[56px] dark:bg-gray-200 bg-white" id="app">
                ...
                <div>
                    ...
                    <div id="mega-menu-icons-dropdown1" class="absolute z-10  hidden w-[300px]  text-sm bg-white border border-gray-100 rounded-lg shadow-md ">
                        <div class="p-4 pb-0 text-gray-900 md:pb-4 ">
                            <ul class="space-y-4" id="notifications" aria-labelledby="mega-menu-icons-dropdown-button">
