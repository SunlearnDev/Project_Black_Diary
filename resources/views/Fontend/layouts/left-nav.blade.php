     ...
     <div class="px-3 pb-4 overflow-y-auto border-r  " >
         ...
         <ul class="space-y-2 font-medium mt-7">
             ...
             <li>
                 <a href="#" class="flex items-center p-2 text-gray-500 rounded-lg hover:bg-gray-100 group">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="w-6 h-6  text-gray-500 transition duration-75 group-hover:text-gray-900">
                         <path stroke-linecap="round" stroke-linejoin="round"
             ...
             <li>
                 <a href="#" class="flex items-center p-2 text-gray-500 rounded-lg hover:bg-gray-100 group">
                     ...
                     <span class="flex-1 ml-3 whitespace-nowrap">Podcart</span>
                 </a>
             </li>
             <!-- Menu item 5 - Notify -->
             <li>
                 <a href="#" class="flex items-center p-2 text-gray-500 rounded-lg hover:bg-gray-100 group">
                     <img src="{{ asset('img/logo/1.png') }}" alt="" class="w-6 h-6  text-gray-500 transition duration-75 group-hover:text-gray-900">
                     <span class="flex-1 ml-3 whitespace-nowrap">About</span>
                 </a>
             </li>
             <li>
                 <a href="#"
                     class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-100 dark:text-gray-500 group">
                     <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-500"
         ...
         <nav class="mb-4" data-testid="other-nav" aria-labelledby="other-nav-heading-sidebar">
             <h2 id="other-nav-heading-sidebar" class=" text-black font-bold mt-6 mb-2 ml-4 ">
                 Other
             </h2>
             <ul class="space-y-2 font-medium mt-4">
                 ...
                 <li>
                     <a href="" class="flex items-center p-2 text-gray-500 rounded-lg hover:bg-gray-100 group">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" class="w-6 h-6  text-gray-500 transition duration-75 group-hover:text-gray-900">
                     ...
                     <a href="" class="flex items-center p-2 text-gray-500 rounded-lg hover:bg-gray-100 group">
                         <span class="c-link__icon">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24"
                                 height="24">
                                 <g transform="translate(4 4)">
                                     <ellipse fill="#F5F8FA" cx="8.828" cy="18" rx="7.953"
                                         ry="13.281" />
                                     <path fill="#E1E8ED"
                                     ...
                                     <ellipse fill="#F5F8FA" cx="27.234" cy="18" rx="7.953"
                                         ry="13.281" />
                                     <path fill="#E1E8ED"
             ...
             {{-- icon MXH --}}
             <div class="flex justify-items-center items-center w-full p-2 mb-4  ">
                 <a href="https://twitter.com" target="_blank"
                     class="mr-2 " rel="noopener me">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         role="img" aria-labelledby="aj8f45ase4a7a5tzom2coqdnve9jzpar"
                         class="crayons-icon c-link__icon">
                         <title id="aj8f45ase4a7a5tzom2coqdnve9jzpar">Twitter</title>
                         <path
                 ...
                 <a href="https://facebook.com" target="_blank"
                     class="mr-2 " rel="noopener me">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         role="img" aria-labelledby="ah37kt0o08lnou6vawck5z10pcq1fxc9"
                         class="crayons-icon c-link__icon">
                         <title id="ah37kt0o08lnou6vawck5z10pcq1fxc9">Facebook</title>
                         <path
                 ...
                 <a href="https://github.com/forem" target="_blank" class="mr-2 "
                     rel="noopener me">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         role="img" aria-labelledby="aeb7koi3w8r4cf1ujh89zn7ti2wkydvt"
                         class="crayons-icon c-link__icon">
                         <title id="aeb7koi3w8r4cf1ujh89zn7ti2wkydvt">Github</title>
                         <path
                 ...
                 <a href="https://instagram.com" target="_blank"
                     class="mr-2 " rel="noopener me">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         role="img" aria-labelledby="a3rii1t9esy2iw4mubl1cd45rs00ac5f"
                         class="crayons-icon c-link__icon">
                         <title id="a3rii1t9esy2iw4mubl1cd45rs00ac5f">Instagram</title>
                         <path
                 ...
                 <a href="https://twitch.com" target="_blank"
                     class="mr-2 " rel="noopener me">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         role="img" aria-labelledby="av5ba1uzk2n4t4r84cwuzr3bnnvgth5"
                         class="crayons-icon c-link__icon">
                         <title id="av5ba1uzk2n4t4r84cwuzr3bnnvgth5">Twitch</title>
                         <path
                 ...
                 <a href="https://fosstodon.org/" target="_blank"
                     class="mr-2 " rel="noopener me">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         role="img" aria-labelledby="a3l6swpsobyvt5mbpmjj8wanu6d47i1i"
                         class="crayons-icon c-link__icon">
                         <title id="a3l6swpsobyvt5mbpmjj8wanu6d47i1i">Mastodon</title>
                         <path
         ...
         <div class="p-2  border-t border-gray-200 mt-2 ">
             <ul class="flex flex-wrap text-xs text-gray-500 ">
                 <li class="list-disc w-auto ml-4 hover:underline hover:text-gray-300 ">
