@if (!Auth::check())
    <div
        class="w-full max-w-full  py-4 px-4  sm:my-auto sm:mr-0 md:w-1/2 md:flex-none lg:w-4/12">
        <form method="post" action="{{ route('user.follow', $data->id) }}" class="flex justify-end items-center">
            @csrf
            <button type="submit"
