@if ($post->user_id)
    <button data-popover-target="popover-user-profile-@empty ($loop)0 @else{{ $loop->iteration }}@endempty" type="button"
    ...
    <!-- Dropdown profiel -->
    <div data-popover id="popover-user-profile-@empty ($loop)0 @else{{ $loop->iteration }}@endempty" role="tooltip"
