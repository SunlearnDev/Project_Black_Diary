        ...
        {{-- show Name --}}
            <div
                ...
                <div class="flex flex-wrap justify-between -mx-3">
                    ...
                    <div class=" flex justify-end items-center py-4 px-4  mx-auto  sm:my-auto sm:mr-0 md:w-1/2 md:flex-none lg:w-4/12">
                        <form action="">
                            @csrf
                            <div class="flex items-center ">
                                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-500 border rounded-lg hover:bg-blue-600 hover:text-white   ">
                                    Folowers
                                </button>
                            </div>
                        </form>
