...
@section('content')
    <main class="">
        <form method="POST" action="" enctype="multipart/form-data" class="grid grid-row-2 gap-2 mt-2">
            @csrf
            {{-- Logo, Edit, Preview --}}
            <div class=" col-span-3 h-[72px] ">
                <div class="grid grid-cols-8 gap-2 h-full items-center">
                    ...
                    <div class="flex items-center h-4 col-start-8">
                        <button type="button"
                            class="text-amber-600 hover:text-white border border-amber-400 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-amber-300 dark:text-amber-300 dark:hover:text-white dark:hover:bg-amber-400 dark:focus:ring-amber-200 ">Preview</button>
                    </div>
                </div>
            </div>
            {{-- Post diary --}}
                ...
                <div class="w-full mb-4 border0 rounded-lg bg-white dark:border-gray-600 px-2">
                    ...
                    <div class="px-4 py-2 bg-white rounded-b-lg ">
                        ...
                        <textarea id="editor" name="content" rows="8"
                            class="block w-full px-0 text-sm text-black bg-white border-0 focus:ring-0 outline-none overflow-hidden dark:placeholder-gray-400"
