                ...
                <div class="mt-4 w-full">
                    <label for="pass" class="text-sm font-medium leading-none text-gray-800">
                      ...
                      <div class="relative flex items-center justify-center">
                        <input id="pass" type="password"  name="password" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" required autocomplete="current-password" />
                      </div>
                </div>
