<header class=" fixed left-0 right-0 top-0 z-10 shadow">
    <nav class="bg-white border-gray-200 dark:bg-black  ">
        <div class="flex   justify-between items-center mx-auto max-w-screen w-full p-4 pr-16">
            <div class=" mr-2">
                <a href="index.php" class="flex items-center justify-start  ">
                    <img src="img/logo/logonote.png" class="h-10 mr-3" alt="Flowbite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Black
                        Diary</span>
                </a>
            </div>
            <nav class="dark:bg-black w-4/5 pr-16">
                    ...
                    <div class="flex items-center justify-center">
                        <ul class="flex flex-row grid grid-cols-4 font-medium mt-0 w-full mx-2 space-x-8 text-sm ">
                            ...
                            <li class="">
                                <!-- message -->
                                <a href="#"
                                    class="text-gray-900 flex justify-center  dark:text-white hover:underline"><svg
                                ...
                                <!-- message đến -->
                                <a href="#"
                                    class="hidden text-gray-900 flex justify-center  dark:text-white hover:underline relative">
                                    <div class="absolute">
                            ...
                            <li class="">
                                <!-- bell -->
                                <a href="#" class="text-gray-900 flex justify-center dark:text-white hover:underline">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <li class="">
                                ...
                                <!-- user 2-->
                                <a href="userpage.php"
                                    class="hidden text-gray-900 flex justify-center dark:text-white hover:underline"><svg
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor"
                                        class="w-6 h-6 text-yellow-600 dark:text-yellow-500 ">
                                        <path stroke-linecap="round" stroke-linejoin="round"
